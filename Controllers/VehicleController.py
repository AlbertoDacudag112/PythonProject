...
class VehicleController:
    ...
    def get_all_vehicles(self):
        """Get all vehicles with owner names and violation counts"""
        return self.vehicle_model.get_all_vehicles()

    def get_vehicle_details(self, vehicle_id: str):
        """Get vehicle details including ResidentID and owner name"""
    ...
    def get_vehicles_for_dropdown(self):
        """
        Get vehicles formatted for dropdown with owner names

        Returns vehicles with these fields:
        - VehicleID
        - PlateNo
        - owner_name (CONCAT of RFirstName and RLastName)
        """
    ...
    def get_total_vehicles(self):
        ...
        return self.vehicle_model.get_total_vehicles()

    def get_vehicles_by_resident(self, resident_id: str):
        """Get all vehicles owned by a specific resident"""
        return self.vehicle_model.get_vehicles_by_resident(resident_id)